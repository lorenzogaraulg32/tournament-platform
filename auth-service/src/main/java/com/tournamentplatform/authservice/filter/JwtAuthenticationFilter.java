package com.tournamentplatform.authservice.filter;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        //L'autorities serve a spring per controllare le autorizzazioni, si controllano tramite il nome del ruolo
        List<SimpleGrantedAuthority> roles = List.of(
                new SimpleGrantedAuthority(role.name())
        );

        //rappresenta l'id utente autenticato con ruoli suoi
