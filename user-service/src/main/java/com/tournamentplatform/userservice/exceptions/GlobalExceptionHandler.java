...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(InvalidSportRoleConfigurationException.class)
    public ResponseEntity<ApiErrorResponse> handleInvalidSportConfiguration(
            InvalidSportRoleConfigurationException exception,
            HttpServletRequest request
    ) {
        return buildResponse(
