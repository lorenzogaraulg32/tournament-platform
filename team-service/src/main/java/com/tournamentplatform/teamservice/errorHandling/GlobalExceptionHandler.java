...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleUserNotOwner(
    ...
    public ResponseEntity<ApiErrorResponse> handleUserNotMember(
    ...
    @ExceptionHandler(OwnerRemovalExcpetion.class)
    public ResponseEntity<ApiErrorResponse> handleOwnerRemoval(
            OwnerRemovalExcpetion exception,
            HttpServletRequest request
    ) {
        return buildResponse(
                HttpStatus.UNAUTHORIZED,
