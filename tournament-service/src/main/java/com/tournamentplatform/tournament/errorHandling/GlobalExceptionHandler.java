...
import com.tournamentplatform.tournament.dto.ApiErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(CantRemoveOwnerException.class)
    public ResponseEntity<ApiErrorResponse> handleCantRemoveOwner(
            CantRemoveOwnerException exception,
            HttpServletRequest request
    ) {
        return buildResponse(
    ...
    @ExceptionHandler(NotTournamentAdminException_BAD_REQUEST.class)
    public ResponseEntity<ApiErrorResponse> handleNotTournamentAdmin_BAD_REQUEST(
            NotTournamentAdminException_BAD_REQUEST exception,
            HttpServletRequest request
    ) {
        return buildResponse(
                HttpStatus.BAD_REQUEST,
    ...
    @ExceptionHandler(NotTournamentAdminException_FORBIDDEN.class)
    public ResponseEntity<ApiErrorResponse> handleNotTournamentAdmin_BAD_REQUEST(
            NotTournamentAdminException_FORBIDDEN exception,
            HttpServletRequest request
    ) {
        return buildResponse(
                HttpStatus.FORBIDDEN,
